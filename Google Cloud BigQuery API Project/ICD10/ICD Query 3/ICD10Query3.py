'''
In this program we select the unique states in our database (not all states are 
represented) and iterate over the states to calculate the percent paid by Medicare by
state for 554.
'''
...
# use DataFrames for this example
