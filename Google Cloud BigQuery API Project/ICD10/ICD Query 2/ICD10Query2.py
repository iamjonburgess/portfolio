'''
In this program we want to know what percent of the total payments for this condition
(MS_DRG code 554) is paid for by Medicare (the remainder paid by the patient).
'''
